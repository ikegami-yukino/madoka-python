...
def bit_scan_reverse(value):
    return _madoka.bit_scan_reverse(value)
...
class Exception(object):
    ...
    def __init__(self, *args):
        _madoka.Exception_swiginit(self, _madoka.new_Exception(*args))

    def what(self):
        return _madoka.Exception_what(self)

# Register Exception in _madoka:
_madoka.Exception_swigregister(Exception)
